...
/**
 * Description of RegistrationAdminFormHandler
 *
 * @author franck
 */
class RegistrationAdminFormHandler implements FormHandlerInterface
{
    /**
     *
    ...
    public function handle(FormInterface $form, Request $request, array $options = null) 
    {
        ...
        $this->handler->createAdmin($form->getData()->getUser(), $request->getClientIp());
        return true;
    }
