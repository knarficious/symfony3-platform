...
/**
 * Description of SendMailToNotActiveUserService
 *
 * @author franck
 */
class SendMailToNotActiveUserService 
{
    /**
     *
    ...
    public function sendMailToNotActiveUsers() 
    {
        $users = $this->userManager->getNotActive();
        ...
        foreach ($users as $user) 
        {
            ...
            $this->logger->info('User '. $user->getUsername(). ' RECEIVED AN EMAIL FOR REMIND CONFIRM'); 
        }
