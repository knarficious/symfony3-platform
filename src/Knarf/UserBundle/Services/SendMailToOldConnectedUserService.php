...
/**
 * Description of SendMailToOldConnectedUserService
 *
 * @author franck
 */
class SendMailToOldConnectedUserService 
{
    /**
     *
    ...
    {
        $users = $this->userManager->getOldConnect();
        ...
        foreach ($users as $user) 
        {
            ...
            $this->logger->info('User '. $user->getUsername(). ' RECEIVED AN EMAIL FOR RECALLING LOGGING'); 
        }
